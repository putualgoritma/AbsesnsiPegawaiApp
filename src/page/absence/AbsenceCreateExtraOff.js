...
const AbsenceCreateExtraOff = ({navigation, route}) => {
  ...
  useEffect(() => {
    // Alert.alert('camera'+route.params.selfie)
  ...
  const sendDataNoImg = () => {
    ...
    RNFetchBlob.fetch(
      'POST',
      Config.REACT_APP_BASE_URL + '/close/absence/absence/storeLocationExtra',
      {
...
export default AbsenceCreateExtraOff;
